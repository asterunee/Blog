...
import { ArrowRight, BookOpenText, Radio, Rss, Search } from "lucide-react";
  ...
  return <div className="blog-home">
    <div className="blog-main-column">
      <section className="blog-masthead">
        ...
        <div className="blog-masthead-copy"><span>DEVELOPMENT · ALGORITHMS · LIFE</span><h1>{siteConfig.koreanSubtitle}</h1><p>{siteConfig.intro}</p></div>
      </section>
    ...
    <aside className="blog-widgets">
      ...
      <section className="blog-widget subscribe-widget"><span><Rss size={13} /> SUBSCRIBE</span><h3>새 글을 놓치지 마세요</h3><p>RSS 리더에서 asterunee의 새 글과 풀이를 받아볼 수 있습니다.</p><Link href="/rss.xml">RSS 피드 구독하기 →</Link></section>
