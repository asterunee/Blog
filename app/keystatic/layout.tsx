...
export default async function KeystaticLayout() {
  ...
  return <html lang="ko" suppressHydrationWarning><body style={{ margin: 0 }}><Link href="/admin/comments" style={{ position: "fixed", zIndex: 9999, right: 18, bottom: 18, padding: "10px 14px", borderRadius: 8, color: "#071017", background: "#5ee7f7", boxShadow: "0 8px 28px rgba(0,0,0,.24)", font: "600 13px system-ui, sans-serif", textDecoration: "none" }}>댓글 관리</Link><KeystaticApp /></body></html>;
}
