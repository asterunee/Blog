  ...
  collections: {
    solutions: collection({
      ...
      schema: {
        ...
        status: fields.select({ label: "풀이 상태", options: [{ label: "Solved", value: "Solved" }, { label: "Upsolved", value: "Upsolved" }, { label: "Example", value: "Example" }], defaultValue: "Solved" }),
    ...
    logs: collection({
      ...
      schema: {
        ...
        updated: fields.date({ label: "수정일", defaultValue: today, ...required }),
        author: fields.select({ label: "작성자", options: [{ label: "asterunee", value: "asterunee" }], defaultValue: "asterunee" }),
        type: fields.select({ label: "기록 종류", options: [{ label: "대회 후기", value: "대회 후기" }, { label: "공부 기록", value: "공부 기록" }, { label: "구현 기록", value: "구현 기록" }, { label: "디버깅 기록", value: "디버깅 기록" }, { label: "짧은 메모", value: "짧은 메모" }], defaultValue: "공부 기록" }),
